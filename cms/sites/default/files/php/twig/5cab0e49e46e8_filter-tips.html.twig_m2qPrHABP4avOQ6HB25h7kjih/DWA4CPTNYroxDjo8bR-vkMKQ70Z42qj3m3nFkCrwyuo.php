...
class __TwigTemplate_ad493a34dc9011e2cc8159471ddee8d1100b7a4c961f87c60011d6187fa64c02 extends \Twig\Template
{
...
$context["name"])))];
                    // line 36
                    echo "      <div";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($context["tip"], "attributes", []), "addClass", [0 => (isset($context["tip_classes"]) ? $context["tip_classes"] : null)], "method")), "html", null, true);
                    echo ">
      <h3>";
                    // line 37
...
(isset($context["long"]) ? $context["long"] : null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "id", [])), ["/" => "-"]))) : (""))];
                        // line 48
                        echo "        <li";
                        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($context["item"], "attributes", []), "addClass", [0 => (isset($context["item_classes"]) ? $context["item_classes"] : null)], "method")), "html", null, true);
                        echo ">";
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "D:\\www\\drupalapp.local\\cms\\core\\themes\\classy\\templates\\content-edit\\filter-tips.html.twig");
    }
}
