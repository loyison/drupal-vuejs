...
class __TwigTemplate_9d0c51a635b27bbed08642a78aa539661607a3e3ea209003469200dba4b62e9e extends \Twig\Template
{
...
(isset($context["overridden"]) ? $context["overridden"] : null)) ? ("overridden") : (""))];
  ...
  ";
        ...
        if ((isset($context["settings_links"]) ? $context["settings_links"] : null)) {
            // line 33
            echo "    ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->safeJoin($this->env, $this->sandbox->ensureToStringAllowed((isset($context["settings_links"]) ? $context["settings_links"] : null)), "<span class=\"label\">&nbsp;|&nbsp;</span>"));
            echo "
  ";
        }
        // line 35
...
";
    ...
    {
        return new Source("", "core/themes/stable/templates/admin/views-ui-display-tab-setting.html.twig", "D:\\www\\drupalapp.local\\cms\\core\\themes\\stable\\templates\\admin\\views-ui-display-tab-setting.html.twig");
    }
}
